 ...
 *
 *   1. PHI element overlay  â€” elements matching PHI_SELECTORS get a
 *      [REDACTED] block overlaid on top before canvas capture.
 *
 *   2. PDF viewer swap      â€” <iframe>, <embed>, <object> PDF viewers and
 ...
 *
 * Both strategies are fully reversible â€” the DOM is always restored even
...
// â”€â”€â”€ PHI overlay management â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€â”€ PDF viewer swap management â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
function buildPdfPlaceholder(rect: DOMRect): HTMLElement {
  ...
  badge.textContent = 'ðŸ”’ PHI PROTECTED';
  badge.style.cssText = `
    margin-top:      8px;
    padding:         4px 12px;
    border-radius:   99px;
...
// â”€â”€â”€ Capture-hide management â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
export function useScreenCapture(): UseScreenCaptureReturn {
  ...
  const capture = useCallback(async (): Promise<ScreenCaptureResult | null> => {
    ...
    try {
      ...
      // Always restore DOM â€” even on error
